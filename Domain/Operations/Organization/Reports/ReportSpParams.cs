...
{
    public static class ReportSpParams
    {
        ...
        public static readonly string PARAMETER_ORDER_BY = "IN_REP_ORDER";
        public static readonly string PARAMETER_GROUPID = "IN_ST_REPG_ID";
        public static readonly string PARAMETER_LANG = "IN_LANG";

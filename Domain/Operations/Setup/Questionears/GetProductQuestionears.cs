...
{
   public class GetProductQuestionears : ProductQuestion, IQueryable
    {
        public async Task<IEnumerable> QueryAsync()
        {
            ...
            return await QueryExecuter.ExecuteQueryAsync<ProductQuestion>(ProductQuestionearsSPName.SP_LOAD_PRODUCT_Question, parameters);
        }
    }
}

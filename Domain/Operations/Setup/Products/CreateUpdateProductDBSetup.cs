...
namespace Domain.Operations.Setup.Products
{
    public static class CreateUpdateProductDBSetup
    {
        public async static Task<IDTO> AddUpdate(Product Product)
        {
            ...
            oracleParams.Add(ProductSPParams.PARAMETER_LOGO, OracleDbType.Varchar2, ParameterDirection.Input, (object)Product.Logo ?? DBNull.Value, 20);
            oracleParams.Add(ProductSPParams.PARAMETER_CODE, OracleDbType.Varchar2, ParameterDirection.Input, (object)Product.Code ?? DBNull.Value, 20);
            ...
            oracleParams.Add(ProductSPParams.PARAMETER_CREATED_BY, OracleDbType.Varchar2, ParameterDirection.Input, (object)Product.CreateBy ?? DBNull.Value, 20);
            ...
            oracleParams.Add(ProductSPParams.PARAMETER_MODIFIED_BY, OracleDbType.Varchar2, ParameterDirection.Input, (object)Product.ModifiedBy ?? DBNull.Value, 20);
            ...
            oracleParams.Add(ProductSPParams.PARAMETER_LOCK_INDV_GROUPE, OracleDbType.Int64, ParameterDirection.Input, (object)Product.LockIndvGroup ?? DBNull.Value);

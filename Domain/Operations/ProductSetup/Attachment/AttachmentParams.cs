...
namespace Domain.Operations.ProductSetup.Attachment
{
    public static class AttachmentParams
    {
        ...
        public static readonly string SP_DELETE_ATTACHMENT = "DBPK_ORG.DEL_ST_ATTCAHMENTS";
        public static readonly string SP_LOAD_ATTACHMENT = "DBPK_ORG.LOAD_ST_ATTCAHMENTS";
    }
}

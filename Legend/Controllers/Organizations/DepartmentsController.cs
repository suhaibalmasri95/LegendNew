...
namespace API.Controllers.Organizations
{
    ...
    public class DepartmentsController : ControllerBase
    {
        ...
        [Route("Load")]
        [HttpGet]
        public IApiResult Load(long? ID, long? CompanyId, long? languageID = 1)
        {
            ...
            {
                return new ApiResult<List<Department>>() { Status = ApiResult<List<Department>>.ApiStatus.Success, Data = (List<Department>)result };
            }
        }
